	...
	public class Cherman0_BalanceTweaks_ForceEmitterTimed : ForceEmitter
	{
		...
		public override bool HandleEvent(EndTurnEvent E)
		{
			...
			if(UptimeRemaining <= 0 && IsActive())
			{
				...
				DestroyBubble();
				CooldownMyActivatedAbility(ActivatedAbilityID, GetDowntime(MyPowerLoadLevel()), activePartFirstSubject);
				MyActivatedAbility(ActivatedAbilityID, activePartFirstSubject).ToggleState = false;
			}
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			...
			else
			{
				...
				MyActivatedAbility(ActivatedAbilityID, activePartFirstSubject).ToggleState = true;
				return base.HandleEvent(E);
			}
		}
